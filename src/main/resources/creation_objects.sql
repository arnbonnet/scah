...
VALUES
 ...
 (nextval('seq_product'), true, 'La vie de l''enfance de Cerise, de Groupama','carnet-cerise.jpg', 0, 15.90, 4, 'Les carnets de Cerise', 'Livre'),
 (nextval('seq_product'), true, 'Les meilleurs vins de bordeaux en BD', 'chateaux-bordeaux.jpg', 0, 22.30, 14, 'Châteaux Bordeaux', 'Livre'),
 (nextval('seq_product'), true, 'Le renouveaux de la lingerie en France', 'culottees.jpg', 0, 16.20, 9, 'Culottées : des femmes qui font ce qu''elles veulent quand elles veulent', 'Livre'),
 (nextval('seq_product'), true, 'Une histoire d''amour poignante', 'et-si-l-amour-c-etait-aimer.jpg', 0, 7.80, 5, 'Et si l''amour c''était aimer ?', 'Livre'),
 (nextval('seq_product'), true, 'Les félin n''ont jamais été si intelligent', 'le-chat-du-rabin.jpg', 0, 10.80, 10, 'Le chat du rabin', 'Livre'),
 (nextval('seq_product'), true, 'Encire une histoire de sous vêtement', 'le-loup-en-slip.jpg', 0, 17.80, 7, 'Le loup en slip', 'Livre'),
 ...
 (nextval('seq_product'), true, 'Un trio de choc.', 'Vieilles-canailles-3-CD-Digipack.jpg', 0, 15.00, 1, 'Dutronc, Hallyday, Mitchell - Les vieilles canailles', 'CD'),
 (nextval('seq_product'), true, 'Un costume impressionnant qui sera surement très prisé des cosplayeurs', 'assassin-s-creed-4.jpg', 0, 24.99, 5, 'Assassin''s Creed 4', 'Jeux Vidéo'),
 (nextval('seq_product'), true, 'Regardez le joueur du grenier pour avoir un avis purement objectif', 'batman-arkham-knight.jpg', 0, 24.99, 3, 'Batman Arkham Knight', 'Jeux Vidéo'),
 (nextval('seq_product'), true, 'Le jeu idéal pour apprendre aux enfants le code de la route', 'cars-3.jpg', 0, 24.99, 115, 'Cars 3', 'Jeux vidéo'),
 (nextval('seq_product'), true, 'Les invasions de zombies n''auront plus de secrets pour vous', 'evil-within-jeu.jpg', 0, 24.99, 1, 'The Evil Winthin 3', 'Jeux vidéo'),
 (nextval('seq_product'), true, 'Le jeu contient une magnifique cinématique des douches dans le vestiaire', 'fifa17.jpg', 0, 24.99, 115, 'Fifa version 17', 'Jeux vidéo'),
 (nextval('seq_product'), true, 'Dans Miitopia, vous menez une quête amusante et décalée avec vos Mii préférés. Rien à voir avec les mitos.', 'miitopia.jpg', 0, 24.99, 15, 'MiiTopia', 'Jeux vidéo'),
 (nextval('seq_product'), true, 'Révisez votre code de la route avec Need For Speed ! ', 'need-for-speed.jpg', 0, 24.99, 1, 'Need For Speed', 'Jeux vidéo'),
 (nextval('seq_product'), true, 'Le jeu le plus mignion de l''univers', 'pikmin.jpg', 0, 24.99, 15, 'Pikmin', 'Jeux vidéo'),
 (nextval('seq_product'), true, 'Sacha a marqué l''esprit d''environ 10 générations', 'pokemon.jpg', 0, 24.99, 13, 'Pokemon', 'Jeux vidéo'),
 (nextval('seq_product'), true, 'Les chevaliers du portail', 'portal-knights.jpg', 0, 24.99, 3, 'Portal Knights', 'Jeux vidéo'),
